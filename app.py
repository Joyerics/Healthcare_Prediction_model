...
def fallback_probability(form_data):
    ...
    alcohol = float(form_data.get("Alcohol_Consumption", defaults["Alcohol_Consumption"]))
...
def index():
    ...
    if request.method == "POST":
        ...
        prediction = "Positive screening alert" if probability >= 0.50 else "No immediate screening alert"
